...
namespace MercadoPagoSDK.Test
{
    ...
    public class MPConfTest
    {
        ...
        public void AttributesConfigurationTests()
        {
            ...
            Assert.AreEqual("https://api.mercadopago.com", SDK.BaseUrl, "MPBase url must be default \"https://api.mercadopago.com\" at this point");
        ...
        public void AppConfigInvalidConfigurationTests()
        {
            ...
            try
            {
                MercadoPagoConfiguration config = null;
        ...
        public MercadoPagoConfiguration GetConfigurationByFileName(string fileName)
        {
            ...
            var config = new MercadoPagoConfiguration();
            config.AccessToken = cfg.ContainsKey("AccessToken") ? cfg["AccessToken"].Value<string>() : string.Empty;
            config.AppId = cfg.ContainsKey("AppId") ? cfg["AppId"].Value<string>() : string.Empty;
            config.ClientId = cfg.ContainsKey("ClientId") ? cfg["ClientId"].Value<string>() : string.Empty;
            config.ClientSecret = cfg.ContainsKey("ClientSecret") ? cfg["ClientSecret"].Value<string>() : string.Empty;
